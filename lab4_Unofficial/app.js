...
var checkChannelsTable = "\n  SELECT EXISTS (\n    SELECT FROM information_schema.tables \n    WHERE table_name = 'lab4'\n  );\n";
pool.query(checkChannelsTable)
    .then(function (result) {
    var _a;
    var tableExists = (_a = result.rows[0]) === null || _a === void 0 ? void 0 : _a.exists;
    if (!tableExists) {
...
app.get('/channels', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query, channels, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                query = 'SELECT * FROM lab4 ORDER BY name';
