...
app.post('/send-message', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, content, animalIdentity, colorIdentity, sendMessageQuery, values, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, content = _a.content, animalIdentity = _a.animalIdentity, colorIdentity = _a.colorIdentity;
                sendMessageQuery = "\n      INSERT INTO messages (content, animal_identity, color_identity)\n      VALUES ($1, $2, $3)\n      RETURNING *;\n    ";
                values = [content, animalIdentity, colorIdentity];
                return [4 /*yield*/, pool.query(sendMessageQuery, values)];
            case 1:
                result = _b.sent();
